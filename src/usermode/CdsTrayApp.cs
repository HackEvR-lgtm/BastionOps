...
namespace CapabilityDenialSystem
{
    ...
    public class CdsTrayApp : ApplicationContext
    {
        ...
        private void InitializeDashboardForm()
        {
            ...
            Label processesLabel = CreateStatLabel("Processes Monitored:", "0");
            processesLabel.Location = new Point(20, 20);
            processesLabel.Name = "processesLabelValue";

            Label threatsLabel = CreateStatLabel("Threats Blocked Today:", "0");
            threatsLabel.Location = new Point(20, 70);
            threatsLabel.Name = "threatsLabelValue";

            Label networkLabel = CreateStatLabel("Network Status:", "Protected");
            networkLabel.Location = new Point(20, 120);
            networkLabel.Name = "networkLabelValue";
            ...
            statsPanel.Controls.Add(processesLabel);
            statsPanel.Controls.Add(threatsLabel);
            statsPanel.Controls.Add(networkLabel);
            ...
            _dashboardForm.Controls.Add(titleLabel);
        ...
        private Label CreateStatLabel(string labelText, string value)
        {
            ...
            foreach (Control ctrl in _dashboardForm.Controls)
            {
                if (ctrl is Panel p)
                {
                    foreach (Control child in p.Controls)
                    {
                        ...
                        {
                            if (lbl.Name == "processesLabelValue")
                            {
                                lbl.Text = $"Processes Monitored:  {_processesMonitored}";
                            }
                            else if (lbl.Name == "threatsLabelValue")
                            {
                                lbl.Text = $"Threats Blocked Today:  {_threatsBlockedToday}";
                            }
                            else if (lbl.Name == "networkLabelValue")
                            {
